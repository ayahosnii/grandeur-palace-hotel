                                    ...
                                    <div class="content-body">
                                        <section class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="card-head">
                                                    <div class="card-header">
                                                        <h4 class="card-title">ملحوظة: اذا قمت باختيار قبول فلن يتم الحذف من الراتب</h4>
                                        ...
                                        <span class="avatar avatar-sm avatar-online rounded-circle">
                                            ...
                                            <i></i>
                                                                                    ...
                                                                                    <div class="media-body media-middle">
                                                                                        <a href="{{route('admin.employees.profile', $attendance->employee->id)}}" class="media-heading">{{ $attendance->employee->name }}({{ $attendance->employee->id }})</a>
                                                                                    </div>
                                                                                </div>
                                                                            </th>
                                                                        </tr>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-4">
                                                                                        <select name="deduction_type">
                                                                                            <option value="present">نسبة مئوية</option>
                                                                                            <option value="fixed_value">قيمة ثابتة</option>
                                                                                        </select>
                                                                                    </div>
                                                                                    <div class="col-md-4">
                                                                                        <input type="text" class="form-control" name="deduction_percentage" value="{{ old('deduction_percentage.'.$loop->index) }}">
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <textarea class="form-control" name="deduction_reason">{{ old('deduction_reason.'.$loop->index) }}</textarea>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
